...
(define-fun |toDec#13| ((state |toDec_s|)) Bool (bvuge ((_ extract 3 0) (|toDec#6| state)) #b0101)) ; $ge$row.v:156$157_Y
(define-fun |toDec#14| ((state |toDec_s|)) (_ BitVec 2) (ite (|toDec#13| state) #b11 #b00)) ; $auto$wreduce.cc:461:run$530 [1:0]
(define-fun |toDec#15| ((state |toDec_s|)) (_ BitVec 12) (bvadd (|toDec#6| state) (concat #b0000000000 (|toDec#14| state)))) ; $add$row.v:156$159_Y
(define-fun |toDec#16| ((state |toDec_s|)) Bool (bvuge ((_ extract 7 4) (|toDec#6| state)) #b0101)) ; $ge$row.v:156$160_Y
(define-fun |toDec#17| ((state |toDec_s|)) (_ BitVec 6) (ite (|toDec#16| state) #b110000 #b000000)) ; $auto$wreduce.cc:461:run$531 [5:0]
(define-fun |toDec#18| ((state |toDec_s|)) (_ BitVec 12) (bvadd (|toDec#15| state) (concat #b000000 (|toDec#17| state)))) ; $add$row.v:156$162_Y
(define-fun |toDec#19| ((state |toDec_s|)) Bool (bvuge ((_ extract 11 8) (|toDec#6| state)) #b0101)) ; $ge$row.v:156$163_Y
(define-fun |toDec#20| ((state |toDec_s|)) (_ BitVec 10) (ite (|toDec#19| state) #b1100000000 #b0000000000)) ; $ternary$row.v:156$164_Y [9:0]
(define-fun |toDec#21| ((state |toDec_s|)) (_ BitVec 12) (bvadd (|toDec#18| state) (concat #b00 (|toDec#20| state)))) ; $add$row.v:156$165_Y
...
(define-fun |toDec#24| ((state |toDec_s|)) (_ BitVec 7) (bvadd #b0110000 (concat #b000 ((_ extract 11 8) (|toDec#6| state))))) ; $add$row.v:170$168_Y
...
(define-fun |toDec#27| ((state |toDec_s|)) Bool (= (|toDec#3| state) #b0111)) ; $eq$row.v:162$166_Y
...
(define-fun |toDec#30| ((state |toDec_s|)) (_ BitVec 4) (bvadd (|toDec#3| state) #b0001)) ; $add$row.v:166$167_Y
...
(define-fun |toDec#33| ((state |toDec_s|)) (_ BitVec 7) (bvadd #b0110000 (concat #b000 ((_ extract 7 4) (|toDec#6| state))))) ; $add$row.v:171$169_Y
(define-fun |toDec#34| ((state |toDec_s|)) (_ BitVec 8) (ite (|toDec#25| state) (concat #b0 (|toDec#33| state)) (|toDec#2| state))) ; $0\tens[7:0]
(define-fun |toDec#35| ((state |toDec_s|)) (_ BitVec 7) (bvadd #b0110000 (concat #b000 ((_ extract 3 0) (|toDec#6| state))))) ; $add$row.v:172$170_Y
...
(define-fun |toHex#4| ((state |toHex_s|)) (_ BitVec 7) (bvadd #b0110111 (concat #b000 (|toHex#0| state)))) ; $add$row.v:126$153_Y
(define-fun |toHex#5| ((state |toHex_s|)) (_ BitVec 7) (bvadd #b0110000 (concat #b000 (|toHex#0| state)))) ; $add$row.v:126$152_Y
(define-fun |toHex#6| ((state |toHex_s|)) Bool (bvule (|toHex#0| state) #b1001)) ; $le$row.v:126$151_Y
...
; yosys-smt2-anyinit hexDecRow#2 8 row.v:200.5-217.8
...
; yosys-smt2-anyinit hexDecRow#21 1 row.v:246.9-256.12
...
; yosys-smt2-anyinit hexDecRow#22 1 row.v:246.9-256.12
...
; yosys-smt2-anyinit hexDecRow#23 1 row.v:246.9-256.12
...
; yosys-smt2-anyinit hexDecRow#24 1 row.v:246.9-256.12
...
; yosys-smt2-anyinit hexDecRow#25 1 row.v:246.9-256.12
...
; yosys-smt2-anyinit hexDecRow#26 8 row.v:246.9-256.12
...
; yosys-smt2-anyinit hexDecRow#27 8 row.v:246.9-256.12
...
; yosys-smt2-anyinit hexDecRow#28 8 row.v:246.9-256.12
...
; yosys-smt2-anyinit hexDecRow#29 8 row.v:246.9-256.12
...
; yosys-smt2-anyinit hexDecRow#30 8 row.v:246.9-256.12
...
; yosys-smt2-anyinit hexDecRow#31 4 row.v:246.9-256.12
...
; yosys-smt2-witness {"offset": 0, "path": ["$formal$row.v:253$189_EN"], "smtname": 32, "smtoffset": 0, "type": "reg", "width": 1}
(declare-fun |hexDecRow#32| (|hexDecRow_s|) (_ BitVec 1)) ; $formal$row.v:253$189_EN
; yosys-smt2-register $formal$row.v:253$189_EN 1
(define-fun |hexDecRow_n $formal$row.v:253$189_EN| ((state |hexDecRow_s|)) Bool (= ((_ extract 0 0) (|hexDecRow#32| state)) #b1))
; yosys-smt2-witness {"offset": 0, "path": ["$formal$row.v:252$188_EN"], "smtname": 33, "smtoffset": 0, "type": "reg", "width": 1}
(declare-fun |hexDecRow#33| (|hexDecRow_s|) (_ BitVec 1)) ; $formal$row.v:252$188_EN
; yosys-smt2-register $formal$row.v:252$188_EN 1
(define-fun |hexDecRow_n $formal$row.v:252$188_EN| ((state |hexDecRow_s|)) Bool (= ((_ extract 0 0) (|hexDecRow#33| state)) #b1))
; yosys-smt2-witness {"offset": 0, "path": ["$formal$row.v:251$187_EN"], "smtname": 34, "smtoffset": 0, "type": "reg", "width": 1}
(declare-fun |hexDecRow#34| (|hexDecRow_s|) (_ BitVec 1)) ; $formal$row.v:251$187_EN
; yosys-smt2-register $formal$row.v:251$187_EN 1
(define-fun |hexDecRow_n $formal$row.v:251$187_EN| ((state |hexDecRow_s|)) Bool (= ((_ extract 0 0) (|hexDecRow#34| state)) #b1))
; yosys-smt2-witness {"offset": 0, "path": ["$formal$row.v:250$186_EN"], "smtname": 35, "smtoffset": 0, "type": "reg", "width": 1}
(declare-fun |hexDecRow#35| (|hexDecRow_s|) (_ BitVec 1)) ; $formal$row.v:250$186_EN
; yosys-smt2-register $formal$row.v:250$186_EN 1
(define-fun |hexDecRow_n $formal$row.v:250$186_EN| ((state |hexDecRow_s|)) Bool (= ((_ extract 0 0) (|hexDecRow#35| state)) #b1))
; yosys-smt2-witness {"offset": 0, "path": ["$formal$row.v:249$185_EN"], "smtname": 36, "smtoffset": 0, "type": "reg", "width": 1}
(declare-fun |hexDecRow#36| (|hexDecRow_s|) (_ BitVec 1)) ; $formal$row.v:249$185_EN
; yosys-smt2-register $formal$row.v:249$185_EN 1
(define-fun |hexDecRow_n $formal$row.v:249$185_EN| ((state |hexDecRow_s|)) Bool (= ((_ extract 0 0) (|hexDecRow#36| state)) #b1))
...
; yosys-smt2-assert 0 $assert$row.v:253$223 row.v:253.24-253.62
(define-fun |hexDecRow_a 0| ((state |hexDecRow_s|)) Bool (or (= ((_ extract 0 0) (|hexDecRow#21| state)) #b1) (not (= ((_ extract 0 0) (|hexDecRow#32| state)) #b1)))) ; $assert$row.v:253$223
; yosys-smt2-assert 1 $assert$row.v:252$222 row.v:252.24-252.62
(define-fun |hexDecRow_a 1| ((state |hexDecRow_s|)) Bool (or (= ((_ extract 0 0) (|hexDecRow#22| state)) #b1) (not (= ((_ extract 0 0) (|hexDecRow#33| state)) #b1)))) ; $assert$row.v:252$222
; yosys-smt2-assert 2 $assert$row.v:251$221 row.v:251.24-251.62
(define-fun |hexDecRow_a 2| ((state |hexDecRow_s|)) Bool (or (= ((_ extract 0 0) (|hexDecRow#23| state)) #b1) (not (= ((_ extract 0 0) (|hexDecRow#34| state)) #b1)))) ; $assert$row.v:251$221
; yosys-smt2-assert 3 $assert$row.v:250$220 row.v:250.23-250.65
(define-fun |hexDecRow_a 3| ((state |hexDecRow_s|)) Bool (or (= ((_ extract 0 0) (|hexDecRow#24| state)) #b1) (not (= ((_ extract 0 0) (|hexDecRow#35| state)) #b1)))) ; $assert$row.v:250$220
; yosys-smt2-assert 4 $assert$row.v:249$219 row.v:249.23-249.66
(define-fun |hexDecRow_a 4| ((state |hexDecRow_s|)) Bool (or (= ((_ extract 0 0) (|hexDecRow#25| state)) #b1) (not (= ((_ extract 0 0) (|hexDecRow#36| state)) #b1)))) ; $assert$row.v:249$219
(define-fun |hexDecRow#38| ((state |hexDecRow_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|hexDecRow#5| state)) #b1) #b1 (|hexDecRow#10| state))) ; $0$formal$row.v:240$184_CHECK[0:0]$193
(define-fun |hexDecRow#39| ((state |hexDecRow_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|hexDecRow#5| state)) #b1) #b1 #b0)) ; $0$formal$row.v:240$184_EN[0:0]$194
; yosys-smt2-assert 5 $assert$row.v:240$218 row.v:240.29-241.48
(define-fun |hexDecRow_a 5| ((state |hexDecRow_s|)) Bool (or (= ((_ extract 0 0) (|hexDecRow#38| state)) #b1) (not (= ((_ extract 0 0) (|hexDecRow#39| state)) #b1)))) ; $assert$row.v:240$218
...
(define-fun |hexDecRow#42| ((state |hexDecRow_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|hexDecRow#5| state)) #b1) (|hexDecRow#41| state) #b0)) ; $0$formal$row.v:249$185_EN[0:0]$204
...
(define-fun |hexDecRow#45| ((state |hexDecRow_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|hexDecRow#5| state)) #b1) (|hexDecRow#44| state) #b0)) ; $0$formal$row.v:250$186_EN[0:0]$206
...
(define-fun |hexDecRow#48| ((state |hexDecRow_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|hexDecRow#5| state)) #b1) (|hexDecRow#47| state) #b0)) ; $0$formal$row.v:251$187_EN[0:0]$208
...
(define-fun |hexDecRow#51| ((state |hexDecRow_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|hexDecRow#5| state)) #b1) (|hexDecRow#50| state) #b0)) ; $0$formal$row.v:252$188_EN[0:0]$210
...
(define-fun |hexDecRow#54| ((state |hexDecRow_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|hexDecRow#5| state)) #b1) (|hexDecRow#53| state) #b0)) ; $0$formal$row.v:253$189_EN[0:0]$212
(define-fun |hexDecRow#55| ((state |hexDecRow_s|)) Bool (= (|hexDecRow#2| state) (|hexDecRow#30| state))) ; $eq$row.v:249$213_Y
...
(define-fun |hexDecRow#57| ((state |hexDecRow_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|hexDecRow#5| state)) #b1) (|hexDecRow#56| state) (|hexDecRow#19| state))) ; $0$formal$row.v:249$185_CHECK[0:0]$203
(define-fun |hexDecRow#58| ((state |hexDecRow_s|)) Bool (= (|hexDecRow#2| state) (|hexDecRow#29| state))) ; $eq$row.v:250$214_Y
...
(define-fun |hexDecRow#60| ((state |hexDecRow_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|hexDecRow#5| state)) #b1) (|hexDecRow#59| state) (|hexDecRow#17| state))) ; $0$formal$row.v:250$186_CHECK[0:0]$205
(define-fun |hexDecRow#61| ((state |hexDecRow_s|)) Bool (= (|hexDecRow#2| state) (|hexDecRow#28| state))) ; $eq$row.v:251$215_Y
...
(define-fun |hexDecRow#63| ((state |hexDecRow_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|hexDecRow#5| state)) #b1) (|hexDecRow#62| state) (|hexDecRow#15| state))) ; $0$formal$row.v:251$187_CHECK[0:0]$207
(define-fun |hexDecRow#64| ((state |hexDecRow_s|)) Bool (= (|hexDecRow#2| state) (|hexDecRow#27| state))) ; $eq$row.v:252$216_Y
...
(define-fun |hexDecRow#66| ((state |hexDecRow_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|hexDecRow#5| state)) #b1) (|hexDecRow#65| state) (|hexDecRow#13| state))) ; $0$formal$row.v:252$188_CHECK[0:0]$209
(define-fun |hexDecRow#67| ((state |hexDecRow_s|)) Bool (= (|hexDecRow#2| state) (|hexDecRow#26| state))) ; $eq$row.v:253$217_Y
...
(define-fun |hexDecRow#69| ((state |hexDecRow_s|)) (_ BitVec 1) (ite (= ((_ extract 0 0) (|hexDecRow#5| state)) #b1) (|hexDecRow#68| state) (|hexDecRow#11| state))) ; $0$formal$row.v:253$189_CHECK[0:0]$211
...
(define-fun |hexDecRow_i| ((state |hexDecRow_s|)) Bool (and
  ...
  (= (= ((_ extract 0 0) (|hexDecRow#32| state)) #b1) false) ; $formal$row.v:253$189_EN
  (= (= ((_ extract 0 0) (|hexDecRow#33| state)) #b1) false) ; $formal$row.v:252$188_EN
  (= (= ((_ extract 0 0) (|hexDecRow#34| state)) #b1) false) ; $formal$row.v:251$187_EN
  (= (= ((_ extract 0 0) (|hexDecRow#35| state)) #b1) false) ; $formal$row.v:250$186_EN
  (= (= ((_ extract 0 0) (|hexDecRow#36| state)) #b1) false) ; $formal$row.v:249$185_EN
...
(define-fun |hexDecRow_t| ((state |hexDecRow_s|) (next_state |hexDecRow_s|)) Bool (and
  (= (|hexDecRow#42| state) (|hexDecRow#36| next_state)) ; $procdff$503 $formal$row.v:249$185_EN
  (= (|hexDecRow#45| state) (|hexDecRow#35| next_state)) ; $procdff$505 $formal$row.v:250$186_EN
  (= (|hexDecRow#48| state) (|hexDecRow#34| next_state)) ; $procdff$507 $formal$row.v:251$187_EN
  (= (|hexDecRow#51| state) (|hexDecRow#33| next_state)) ; $procdff$509 $formal$row.v:252$188_EN
  (= (|hexDecRow#54| state) (|hexDecRow#32| next_state)) ; $procdff$511 $formal$row.v:253$189_EN
